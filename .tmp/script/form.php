...
$my_email = "info@divorceandwellbeing.co.uk";
...
$message = $message . PHP_EOL.PHP_EOL."-- ".PHP_EOL."This message was sent from your comments box on Divorce and Wellbeing";
...
<body>
    <header>
        <section>
            <a href="index.html">
                <img class="logo-main" src="../img/brand/logo-main.png">
            </a>
        </section>
    </header>
    <main class="overlap">
            ...
            <section>
                <div class="inner">
                    <div class="left oversized">
                        <p>Thank you <?php if(isset($_REQUEST['name'])){print stripslashes($_REQUEST['name']);} ?></p>
