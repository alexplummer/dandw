...
<head>
    ...
    <title>
        <cms:editable name='page_title' type='text'>Blog</cms:editable>
    </title>
...
<body>
    ...
    <cms:template title="Blog post" clonable="1" commentable="1">
    </cms:template>
    <main>
        <section class="news">
            <div class="inner">
                <article>
                    <h1><cms:editable name='article_header' type='text'>Enter the blog header here</cms:editable></h1>
                    <div class="details">
                        <time>
                    ...
                    <p>
                        <cms:editable name='article_prefix' type='text'>Dear Readers,</cms:editable>
                    </p>
                    <p>
